class Observations::Activity < ApplicationRecord
  ...
  enum questiond: [ :not_observed, :no_relation, :shows_progress, :meets_standard, :exceeds_standard ]
  enum questione: [ :not_observed, :no_relation, :shows_progress, :meets_standard, :exceeds_standard ]
