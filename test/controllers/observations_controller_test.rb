...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post observations_url, params: { observation: { classroom_id: @observation.classroom_id, comments: @observation.comments, principal_id: @observation.principal_id, specialist_id: @observation.specialist_id } }
    end
  ...
  test "should update observation" do
    patch observation_url(@observation), params: { observation: { classroom_id: @observation.classroom_id, comments: @observation.comments, principal_id: @observation.principal_id, specialist_id: @observation.specialist_id } }
